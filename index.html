...
<!--   Top fixed menu bar start here-->
      <div class="navbar navbar-inverse navbar-fixed-top">
         ...
         <div class="collapse navbar-collapse pull-right">
            <ul class="nav navbar-nav navbar-nav-margin">
               <li class="active">
                  <a href="#" class="dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span><span class="caret"></span></a>
      ...
      <!--   Top fixed menu bar Ends here-->
	  <!--/Side bar nad content wrapper end here -->
               ...
               <ul id="myTab" class="nav nav-pills nav-stacked">
                  <li class="active">
                     <a href="#">
                        ...
                        <span class="col-xs-offset-1">Home</span>
                     </a>
                  </li>
                  <li>
                     <a href="#">
                        <div class="glyphicon glyphicon-user"></div>
                        <span class="col-xs-offset-1">Self Evaluation</span><span class="label label-warning pull-right">16/24</span>
                     </a>
                  </li>
                  <li>
                     <a  href="#">
                        <div class="glyphicon glyphicon-certificate"></div>
                        <span class="col-xs-offset-1">Goal Settings</span><span class="label label-success m-l-5 pull-right">NEW</span>
                     </a>
                  </li>
                  <li>
                     <a id="maian-menu" href="#">
                        <div class="glyphicon glyphicon-stats"></div>
                        <span class="col-xs-offset-1">Report</span><b class="caret pull-right"></b>
                     </a>
                  ...
                  <li>
                     <a href="#">
                        ...
                        <span class="col-xs-offset-1">Help</span>
                     </a>
                  </li>
               </ul>
            </div>
            ...
            <div class="col-md-12">
               ...
               <div class="row">
                  <div class="col-lg-4 col-sm-6">
                     <div class="well">4 cols, 6 small cols</div>
                  </div>
                  <div class="col-lg-4 col-sm-6">
                     <div class="well">4 cols, 6 small cols</div>
                  </div>
                  <div class="col-lg-4 col-sm-12">
                     <div class="well">4 cols, 12 small cols</div>
                  </div>
               </div>
               <br>
